...
export class GameBetController extends Controller {
    ...
    public async createOne(req: IGetUserAuthInfoRequest, res: Response, next: NextFunction) {
        try {
    ...
    public async getMany(req: IGetUserAuthInfoRequest, res: Response, next: NextFunction) {
        try {
