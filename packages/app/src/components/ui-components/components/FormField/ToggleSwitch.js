...
const ToggleSwitch = (_a) => {
    ...
    return (jsx_runtime_1.jsxs(components_1.Wrapper, Object.assign({ className: wrapperClassName }, { children: [jsx_runtime_1.jsx(ToggleSwitch_1.ToggleSwitch, Object.assign({ id: field.name, label: label, name: field.name, value: valueToSet, onChange: field.onChange, onBlur: field.onBlur, checked: valueToSet === field.value }, props), void 0),
