...
const Select = (_a) => {
    ...
    return (jsx_runtime_1.jsxs(components_1.Wrapper, Object.assign({ className: wrapperClassName }, { children: [label && (jsx_runtime_1.jsx(components_1.Label, Object.assign({ htmlFor: field.name, className: labelClassName }, { children: label }), void 0)),
            jsx_runtime_1.jsx(Select_1.Select, Object.assign({ id: field.name, name: field.name, value: field.value, onChange: field.onChange, onBlur: field.onBlur }, props), void 0),
