...
class AppService extends ApiService_1.ApiService {
  constructor() {
    ...
    this.getUser = () =>
      localStorage_service_1.localStorageService.get(
        _constants_1.StorageKeys.User,
      );
    this.validateInvitationToken = (token) =>
      this.get(urls_1.URLS.TOKENS.MAIL_INVITATION + token);
    this.logout = () => {
    ...
    this.isLoggedIn = () => {
      return [
        ...
        Boolean(localStorage_service_1.localStorageService.get(storageKey)),
      );
    };
  }
}
