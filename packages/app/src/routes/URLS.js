...
exports.URLS = {
    ...
    MAIL_INVITATION_SIGNUP: createTemplate_1.createTemplate('/mail-invitation-signup'),
    INVALID_MAIL_INVITATION_SIGNUP_TOKEN: createTemplate_1.createTemplate('/invalid-signup-token'),
