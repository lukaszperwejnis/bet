        ...
        userService.resetPassword({token, password}).then((result) => {
            ...
            switch (result.status) {
                case 500:
                    ...
                    return;
                case 422:
                    messageActions.error(translate('setPassword.error.passwordIsEqualWithPrevious'));
                    return;
                case 200:
            ...
            <PageTile header={<FormattedMessage id="setPassword.header" />}>
                <Formik validationSchema={schema} initialValues={{password: '', confirmedPassword: ''}} onSubmit={onSubmit}>
                    <Form>
                        ...
                        <FormField.Input name="confirmedPassword" placeholder={translate('fields.confirmed-password')} type="password" />
