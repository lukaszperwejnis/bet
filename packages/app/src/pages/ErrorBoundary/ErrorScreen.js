...
const Title = styled_components_1.default.h3 `
  ...
  font-family: ${config_1.config.fontFamily.primary};
`;
const ErrorScreen = () => (jsx_runtime_1.jsxs(ErrorPage, Object.assign({ centered: true }, { children: [jsx_runtime_1.jsx(ErrorCode, { children: "500" }, void 0),
        jsx_runtime_1.jsx(Title, { children: "Oops, co\u015B posz\u0142o nie tak" }, void 0)] }), void 0));
