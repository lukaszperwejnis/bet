...
const ResetPassword = () => {
    ...
    const { token } = query;
    const { isLoading, hasInvalidToken } = react_redux_1.useSelector((store) => store.password);
    ...
    return (jsx_runtime_1.jsx(_components_1.Page, Object.assign({ centered: true }, { children: jsx_runtime_1.jsx(_components_1.PageTile, Object.assign({ header: jsx_runtime_1.jsx(react_intl_1.FormattedMessage, { id: "resetPassword.header" }, void 0), isLoading: isLoading }, { children: jsx_runtime_1.jsx(formik_1.Formik, Object.assign({ validationSchema: schema, initialValues: formInitialValues, onSubmit: onSubmit }, { children: jsx_runtime_1.jsxs(_components_1.StyledForm, { children: [jsx_runtime_1.jsx(ui_components_1.FormField.Input, { name: "password", placeholder: translate('fields.password'), type: "password" }, void 0),
                        jsx_runtime_1.jsx(ui_components_1.FormField.Input, { name: "confirmedPassword", placeholder: translate('fields.confirmedPassword'), type: "password" }, void 0),
                        jsx_runtime_1.jsx(_components_1.Submit, Object.assign({ disabled: isLoading }, { children: jsx_runtime_1.jsx(react_intl_1.FormattedMessage, { id: "resetPassword.cta.submit" }, void 0) }), void 0)] }, void 0) }), void 0) }), void 0) }), void 0));
};
