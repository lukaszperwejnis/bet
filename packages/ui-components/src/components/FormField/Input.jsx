...
var Input = function (_a) {
    ...
    var hasError = Boolean(errorMessage || (meta.touched && meta.error));
    ...
    return (<components_1.Wrapper className={wrapperClassName}>
      ...
      <Input_1.Input id={field.name} name={field.name} value={field.value} onChange={field.onChange} onBlur={field.onBlur} isInvalid={hasError} {...props}/>
