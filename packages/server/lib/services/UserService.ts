...
export class UserService {
    ...
    async updatePassword(input: any): Promise<Boolean> {
        ...
        const result = await this.userRepository.findOneAndUpdate({_id: userId}, password);
    ...
    async resetPassword(input: any): Promise<Boolean> {
        ...
        const tokenPayload: any = await this.tokenService.verifyResetPasswordToken(input.token);
        ...
        const result = await this.userRepository.findOneAndUpdate({email: tokenPayload.email}, {
